				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							<h1 class="fs-4 card-title fw-bold mb-4 center_h1">REGISTER</h1>
							<form method="POST">
								<div class="txtb">
								...
								<input id="button" type="submit" name="submit" value="Register" class="btn btn-primary ms-auto logbtn">
							</form>
						</div>
						
						<div class="card-footer py-3 border-0">
							<div class="text-center">Already have an account? <a class="text-dark" href="login.php">Click here to Login</a>
							</div>
						</div>
					</div>
